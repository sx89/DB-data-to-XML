...
@EnableJpaRepositories(
        ...
        basePackages = {
                "com.sx.createxml.dao.repository4"
        }
)
public class ForthConfig {
     ...
     * 注入 mysql数据源
     */
    @Resource(name = "forthDataSource")
    private DataSource forthDataSource;
    ...
    private Map<String, Object> getVendorProperties() {
        ...
        ret.put("hibernate.physical_naming_strategy", "org.hibernate.boot.model.naming.PhysicalNamingStrategyStandardImpl");
...
//                "org.hibernate.boot.model.naming.PhysicalNamingStrategyStandardImpl");
    ...
    forthEntityManagerFactory(
            EntityManagerFactoryBuilder builder) {
        return builder
                .dataSource(forthDataSource)
                .properties(getVendorProperties())
                .packages("com.sx.createxml.pojo.flowcore")
                .persistenceUnit("db4")
                .build();
    }
     ...
     * @return 实体管理器
     */
    @Bean(name = "forthEntityManager")
    public EntityManager entityManager(EntityManagerFactoryBuilder builder) {
        return forthEntityManagerFactory(builder).getObject().createEntityManager();
    }
    ...
    public PlatformTransactionManager forthTransactionManager(
            EntityManagerFactoryBuilder builder) {
        return new JpaTransactionManager(forthEntityManagerFactory(builder).getObject());
    }
}